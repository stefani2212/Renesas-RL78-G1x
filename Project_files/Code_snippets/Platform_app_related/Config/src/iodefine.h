...
/*! \union DT_SMR00bits(Serial Mode Register)
    \brief SMR00 register data type definition.
 */
union DT_SMR00bits {
    struct {
        unsigned char MD0: 1;
...
#define _SFR_SMR00 (*(volatile union DT_SMR00bits *)0xF0110u).u8
#define _SFR_SMR00bits (*(volatile union DT_SMR00bits *)0xF0110u).bits

union DT_SCR00bits {
    struct {
        unsigned char DLS: 1;
        unsigned char DLS1: 1;
        unsigned char : 1;
        unsigned char : 1;
        unsigned char : 1;
        unsigned char : 1;
...
#define _SFR_SCR00 (*(volatile union DT_SCR00bits *)0xF0118u).u8
#define _SFR_SCR00bits (*(volatile union DT_SCR00bits *)0xF0118u).bits



#define _SFR_SDR00 (*(volatile unsigned short *)0xFFF10u)
/*
 IO Registers
 */
union un_p0 {
...
/*Added for PMC0,PMC1,PMC10,PMC12,PMC14*/
union un_pmc1 {
	unsigned char pmc1;
	__BITS8 BIT;
};
...
//recently ADDED***************************************
#define PMC0 (*(volatile union un_pmc0 *)0xF0060u).pmc0 
#define PMC0_bit (*(volatile union un_pmc0 *)0xF0060u).BIT 
//*****************************************************
